...
dx_build=6.1.2.43047 #Builds from here https://dwspectrum.digital-watchdog.com/download/linux Note full build No.
dx_rev=43047
echo ""
echo ""
...
echo ""
echo ""
wget "https://updates.digital-watchdog.com/digitalwatchdog/$dx_rev/linux/dwspectrum-server-$dx_build-linux_x64.deb" -P ~/Downloads
